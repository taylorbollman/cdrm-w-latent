"""CPU linear schedule, exact initialization, first-step gradient and resume checks."""
import copy
import hashlib
import json
...
from scripts import rt_a5_linear_input_train as driver
...
@pytest.mark.parametrize("step, expected", [(-1, 0.), (0, 0.), (1, 2e-7),
    (10000, .002), (20000, .004), (50000, .01), (60000, .01)])
def test_linear_boundaries(step, expected):
