...
SCHEMA = 'rt-a5-six-layer-value-25k-report-v1'
...
REPORTING_SOURCES = ('scripts/rt_a5_six_layer_value_25k_report.py', 'scripts/rt_a5_six_layer_input_report.py',
...
def terminal(report, protocol):
    ...
    require((start,endpoint) in ((0,10000),(10000,25000)), 'Unknown value pilot/continuation stage')
...
def load_evidence(lineage):
    ...
    if start:
        ...
        require(decision['decision'] == 'continue_to25000' and decision['E36_count'] > 0
