"""The existing four-layer input bypass with a conservative nonlearned quadratic warmup."""
...
CONFIG_PATH = Path(__file__).resolve().parents[1] / "configs/rt_a5_conservative_input/base.json"
...
def build_model(width=512, seed=1234, predictor_seed=1235, device="cpu", *,
    ...
    model.nextlat_initialization = {
        **original, "schema": "rt-a5-conservative-input-initialization-v1",
