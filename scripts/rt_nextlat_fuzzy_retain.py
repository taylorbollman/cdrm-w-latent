#!/usr/bin/env python3
"""Retain a completed pilot's explicit runtime/report artifacts on GCS."""
...
def main():
    ...
    if not args.prefix.startswith("gs://fast-chunks/cdrm-w-latent/rt-nextlat-fuzzy-a5/"):
    ...
    blob.metadata = {"sha256": sha, "artifact_schema": "rt-nextlat-fuzzy-evidence-v1"}
    ...
    receipt = {"schema": "rt-nextlat-fuzzy-retention-v1", "status": "verified",
