...
SCHEMA = 'rt-a5-six-layer-head-25k-report-v1'
TRAIN_SCHEMA = 'rt-a5-six-layer-head-training-v1'
SOURCE_SHA = 'af1fae94e25dfc6982b549157d47ed9492e0e2896a368741a5ec6c39274a434f'
COLUMNS = CSV_COLUMNS
REPORTING_SOURCES = ('scripts/rt_a5_six_layer_head_25k_report.py', 'scripts/rt_a5_six_layer_input_report.py',
...
def terminal(report, protocol):
    ...
    require((start,endpoint) in ((0,10000),(10000,25000)), 'Unknown head pilot/continuation stage')
